...
module.exports.findBooksByTitle = function findBooksByTitle (req, res, next, title) {
...
module.exports.updateBookWithForm = function updateBookWithForm (req, res, next, bookId) {
  Book.updateBookWithForm(bookId)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.uploadFile = function uploadFile (req, res, next, body, bookId) {
  Book.uploadFile(body, bookId)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
